...
export default class SettingsScreen extends Phaser.Scene {
  ...
  editorCreate(): void {
    ...
    // a_tile_action
    const a_tile_action = this.add.tileSprite(
      0,
      0,
      47,
      47,
    ...
    // b_tile_action
    const b_tile_action = this.add.tileSprite(
      0,
      0,
      47,
      47,
    ...
    // y_tile_action
    const y_tile_action = this.add.tileSprite(
      0,
      0,
      47,
      47,
    ...
    const startMenuButtonStartSceneOnClick = new StartSceneOnClick(
      startMenuButton
    )
